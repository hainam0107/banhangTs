import { urlserver, CSanPham, CThuocTinh } from './common.js';
const onePro = (pro) => {
...
export const getProRelate = async (idCate, currentProductId) => {
...
export const proHot = async (numPro) => {
...
export const getOnePro = async (id = 0) => {
    ...
    let { mauMat, baoHanh, chongNuoc, mauDay, dangMatSo, gioiTinh, loaiDay, loaiKinh, loaiMay, size, hang, thuongHieu } = thuocTinh;
    let obj = new CThuocTinh(id, idCate, name, price, price_sale, image, hot, view, brand, sku, protype, mauMat, baoHanh, chongNuoc, mauDay, dangMatSo, gioiTinh, loaiDay, loaiKinh, loaiMay, size, hang, thuongHieu);
    let str = `
    <div class="row mt-5">
    <div class="col-md-6">
